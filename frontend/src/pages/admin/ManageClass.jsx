...
const ManageClasses = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post("/api/class/create", formData);
      setShow(false);
        ...
        <tbody>
          {classes.map(cls => (
            <tr key={cls._id}>
              ...
              <td>{cls.capacity}</td>
              <td>{cls.teacher_id.account_id.system_name}</td>
              <td>
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-2">
              ...
              >
                ...
                {teachers
                  .filter(t => t._id && t.account_id.email)
                  .map(t => (
                    <option key={t._id} value={t._id}>{t.account_id.system_name}</option>
                  ))}
              </Form.Select>
            </Form.Group>
