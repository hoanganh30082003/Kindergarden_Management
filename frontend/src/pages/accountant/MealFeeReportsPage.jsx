...
const MealFeeReportsPage = () => {
  ...
  const fetchReport = async () => {
    try {
      ...
      const response = await reportService.getMealFeeReports(cleanFilters);
      setReportData(response.data);
    } catch (err) {
      setError(err.response?.data?.message || 'Failed to fetch meal fee reports');
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    <AccountantLayout 
      ...
      subtitle="Generate detailed reports on meal revenue by student, class and time periods"
    >
      <Row>
        <Col>
            ...
            <Card.Body>
              ...
              {loading && (
                <div className="text-center py-5">
                  ...
                  <p className="mt-2 text-muted">Generating meal fee report...</p>
                </div>
              )}
                      ...
                      <Row>
                        <Col lg={3} md={6} className="mb-3">
                          <div className="text-center p-3 border rounded">
                            <div className="mb-2">
                              <i className="fas fa-hamburger fa-2x text-success"></i>
                            </div>
                            <h4 className="text-success mb-1">
                              {formatCurrency(reportData.summary.grand_total)}
                            </h4>
                            <small className="text-muted">Total Meal Revenue</small>
                          </div>
                        </Col>
                        <Col lg={3} md={6} className="mb-3">
                          <div className="text-center p-3 border rounded">
                  ...
                  <Card className="border-0 shadow-sm">
                    <Card.Header className="bg-white border-0">
                      <h6 className="mb-0">
                        ...
                        Detailed Report - {filters.group_by === 'class' ? 'By Class' : 'By Student'}
                      </h6>
                    </Card.Header>
                    <Card.Body>
                          ...
                          <thead className="table-light">
                            <tr>
                              {filters.group_by === 'class' ? (
                                ...
                                <>
                                  <th className="border-0">
                                    <i className="fas fa-user-graduate me-1"></i>Student Name
                                  </th>
                                  <th className="border-0">
                              ...
                              return (
                                <tr key={index}>
                                  {filters.group_by === 'class' ? (
                                    ...
                                    <>
                                      <td>
                                        <strong className="text-success">{item.student_name}</strong>
                                      </td>
                                      <td>
                      ...
                      {reportData.details.length === 0 && (
                        <div className="text-center py-5">
                          ...
                          <p className="text-muted">
                            No meal fee data available for the selected filters.
                          </p>
...
export default MealFeeReportsPage;